...
The [recorded 2026-09-05 run](recorded/2026-09-05/README.md) includes raw
artifacts, hashes and build provenance. It documents the API-path and HTTP
completion boundaries observed in this pinned build, with engine reuse unknown.
