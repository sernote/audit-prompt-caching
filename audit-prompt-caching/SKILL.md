...
- OpenAI-compatible vendors (label usage records with the vendor so inclusive/additive semantics resolve): Moonshot/Kimi -> `references/moonshot.md`; MiniMax -> `references/minimax.md`; xAI Grok -> `references/xai.md`; Mistral -> `references/mistral.md`.
