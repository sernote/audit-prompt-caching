...
- [ ] Commit the tested changes on the isolated `codex/` branch and prepare a draft pull request with the concrete example, supported input contract, limitations and test results.
